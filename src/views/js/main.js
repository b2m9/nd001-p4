...
(function(w, d) {
  ...
  var perfAvailable = (window.performance.mark && window.performance.measure) ? true : false;
  //var generationWorker = new Worker("js/worker.js");

  document.addEventListener("DOMContentLoaded", createMovingPizzas);
  ...
  function createMovingPizzas() {
    ...
    document.querySelector("#header").appendChild(root);
