this.onmessage = function(e) {
  ...
  for (; i < len; i++) {
    // outer container
    str += "<div id='pizza" + i + "' class='" + className + "' style='width:" + width + "; height:" + height + "'>";

    // image container
    str += "<div class='col-md-6'><img src='" + imgSrc + "' class='img-responsive'></div>";

    // description container
    str += "<div class='col-md-6'><h4>" + randomName() + "</h4><ul>" + makeRandomPizza();
...
function makeRandomPizza() {
  ...
  for (i = 0; i < numberOfMeats; i++) {
    pizza += "<li>" + selectRandomMeat() + "</li>";
  }

  for (i = 0; i < numberOfNonMeats; i++) {
    pizza += "<li>" + selectRandomNonMeat() + "</li>";
  }

  for (i = 0; i < numberOfCheeses; i++) {
    pizza += "<li>" + selectRandomCheese() + "</li>";
  }

  pizza += "<li>" + selectRandomSauce() + "</li><li>" + selectRandomCrust() + "</li>";
